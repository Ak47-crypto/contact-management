...
const ProductView = () => {
  ...
  useEffect(()=>{
    console.log(searchParams.get('contactId'));
              ...
              <CardContent className="p-0">
                ...
                <div className="flex gap-2 mt-4 overflow-x-auto pb-2 md:justify-end md:items-center">
                    ...
                    <div
                      ...
                      className="relative w-20 h-20 md:w-60 md:h-60 flex-shrink-0 rounded-md overflow-hidden cursor-pointer border-2 border-transparent hover:border-primary transition-colors "
                    >
                      <Image
                        src={"/user.svg"}
                        alt={`user icon`}
